...
ADD COLUMN THOI_DIEM_THONG_BAO DATETIME NULL,
ADD COLUMN ID_MUC CHAR(8) NULL,
ADD CONSTRAINT fk_cauhinh_muc
    FOREIGN KEY (ID_MUC)
    REFERENCES muc_cong_viec(ID_MUC)
    ON DELETE SET NULL
    ON UPDATE CASCADE;
-- 10. LỜI MỜI
