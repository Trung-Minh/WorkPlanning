...
@section('content')
    <main class="w-full pt-2 mx-auto mt-1 sm:w-3/4 md:w-2/3 lg:w-3/5 ">
    <div class="grid grid-cols-1 gap-2 p-6 bg-white shadow-md lg:grid-cols-1 xl:grid-cols-2 rounded-3xl">
    <!-- Column 1 -->
    ...
    <div  class="px-4 py-6 2xl:px-8 lg:py-12" >
        ...
        <p class="flex items-center justify-center gap-2 mb-4 text-center text-gray-600"><a href="/login" class="hover:text-blue-800">Login</a> | <a href="/repassword" class="hover:text-blue-800">Forgot Password</a></p>
