...
@section('content')
    <main class="w-full pt-2 mx-auto mt-1 sm:w-3/4 md:w-5/10 lg:w-5/10 ">

    <div class="grid grid-cols-1 gap-2 p-6 bg-white shadow-md md:grid-cols-1 lg:grid-cols-2 rounded-3xl"> <!-- Parent container (flex) -->
    <!-- Column 1 -->
    ...
    <div class="px-4 py-6 mt-0 rounded-lg  lg:mt-8">
        ...
        <input type="text" name="email" id="email" placeholder="Email" required class="w-full px-3 py-2 border rounded"
        value="{{ old('email') }}" />
        </div>
        ...
        <button type="submit" class="w-full py-2 text-lg text-white bg-blue-600 rounded hover:bg-blue-700">
        Đăng nhập
        </button>
        </form>
        <p class="flex items-center justify-center gap-2 mb-4 text-center text-gray-600"><a href="/register" class="hover:text-blue-800">Register</a> | <a href="/repassword" class="hover:text-blue-800">Forgot Password</a></p>
    </div>
    </div>
