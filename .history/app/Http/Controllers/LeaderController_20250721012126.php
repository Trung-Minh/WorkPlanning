...
class LeaderController extends Controller   
{
    ...
    public function doGroup(Request $request){
     ...
     public function doGroups(Request $request){
        ...
        Nhom::where('ID_NHOM', $request->input('id_nhom'))->update(['TEN_NHOM' => $request->ten_nhom])->first();
        $nhom = Nhom::where('ID_NHOM', $request->input('id_nhom'))->update(['TEN_NHOM' => $request->ten_nhom])->first();
