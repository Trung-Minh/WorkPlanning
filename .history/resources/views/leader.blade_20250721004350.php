...
<!-- Editable heading -->
<div x-data="{ editing: false, tenNhom: '{{ $nhom->TEN_NHOM }}', tenMoi: '' }" class="text-center">

    <!-- Hiển thị <h1> nếu không chỉnh sửa -->
    <h1 x-show="!editing"
        @dblclick="editing = true; tenMoi = tenNhom"
    ...
    <input x-show="editing"
           ...
           class="border rounded px-2 py-1 text-lg text-center w-full"
           type="text"
           :value="tenMoi"
           autofocus />
</div>            <h2 class="text-xl font-semibold mb-4">Invite Team Members</h2>
