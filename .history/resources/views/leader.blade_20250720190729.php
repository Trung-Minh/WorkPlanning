...
@section('content')
    ...
    <a href="#"
        class="absolute bottom-4 right-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-5 rounded-full shadow-lg text-sm z-10">
        + Tạo nhóm
    </a>
    <main class="relative w-full pt-2 mx-auto mt-5 sm:w-3/4 md:w-5/10 lg:w-5/10 ">
